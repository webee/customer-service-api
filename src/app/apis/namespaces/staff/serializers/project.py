...
session_item = api.model('Session Item', {
    ...
    'last_session_msg': fields.Nested(message, allow_null=True, description='last session msg'),
...
class SessionItemSchema(ma.Schema):
    class Meta:
        fields = (
            'id', 'project', 'created', 'closed', 'handler', 'start_msg_id', 'msg_id', 'msg', 'last_session_msg',
            'sync_msg_id', 'handler_msg_id', 'msg_count', 'unsynced_count', 'unhandled_count')
