...
fetch_handling_sessions_args.add_argument('exclude_self', type=inputs.boolean, required=False)
...
fetch_handled_sessions_args.add_argument('unhandled_msg_count_range', type=NumberRange(int), required=False)
fetch_handled_sessions_args.add_argument('msg_ts_range', type=DateTimeRange(), required=False)
fetch_handled_sessions_args.add_argument('tag', type=str, required=False)
fetch_handled_sessions_args.add_argument('exclude_self', type=inputs.boolean, required=False)
